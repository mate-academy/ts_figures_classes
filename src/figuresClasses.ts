...
// Write an interface `Figure` and 3 classes
// implementing it so that every figure
// has:
...
// - use [Heron's formula]
// (://en.wikipedia.org/wiki/Heron%27s_formula) for triangles
...
// Also create a function `getInfo` that
// takes a figure and returns a string in the
// next format:
// ```typescript
...
// function roundAreaToThousands(area) {
...
// export function createFigure(type, color, sideA, sideB): void {
//   type;
// }
