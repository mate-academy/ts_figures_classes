...
export class Triangle implements Figure {
  ...
  constructor(
    ...
    if (this.a <= 0 || this.b <= 0 || this.c <= 0) {
      throw Error(`Error! Sides could't be negative.
    ...
    if ((this.a + this.b <= this.c)
      ...
      throw Error(`Error! It is not a triangle.
        ...
        must be bigger than the 3d side`);
    }
  }
...
export class Circle implements Figure {
  ...
  constructor(
    ...
    if (this.radius < 0) {
      throw Error(`Error! Radius could't be negative.
        Please, enter the valid value`);
    }
  }
...
export class Rectangle implements Figure {
  ...
  constructor(
    ...
    if (this.width < 0 || this.height < 0) {
      throw Error(`Sides could't be negative.
        Please, enter the valid value`);
    }
  }
